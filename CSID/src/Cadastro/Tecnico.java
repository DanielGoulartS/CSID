 ...
 * @author Daniel
 */
public class Tecnico extends Comandante {
    ...
    public static ActionListener aceitarSolicitacao(JLabel labelEncarregado, Solicitacao solicitacao, JButton este,
    ...
    public static void atribuir(JLabel labelEncarregado, Solicitacao solicitacao, JButton este,
        ...
        if (permit == 0) {
            ...
            jTAS.conexao.execute("UPDATE solicitacao SET encarregado = " + jTAS.usuario.id
    ...
    public static void desatribuir(JLabel labelEncarregado, Solicitacao solicitacao, JButton este,
            JanelaTodasAsSolicitacoes jTAS) throws SQLException {
        ...
        if (permit == 0) {
            ...
            jTAS.conexao.execute("UPDATE solicitacao SET encarregado = 0 WHERE id = '" + solicitacao.id + "'"
