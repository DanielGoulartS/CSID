...
public class Administrador extends Usuario {
    ...
    public static ActionListener cadastrarPortos(JanelaCadastrarPortos jCP) {
        return (ActionEvent e) -> {
            ...
            jCP.porto = new Porto("", jCP.tfTelefone.getText(), jCP.tfNome.getText().replaceAll(" ", ""), 
                    jCP.tfEndereco.getText(), jCP.tfEmail.getText());
    ...
    public static ActionListener cadastrarServicos(JanelaCadastrarServicos jCS) {
        return (ActionEvent e) -> {
            ...
            jCS.servico = new Servico("", jCS.tfNome.getText().replaceAll(" ", ""), jCS.tfDescricao.getText());
    ...
    public static ActionListener excluirServicos(JanelaCadastrarServicos jCS) {
        return (ActionEvent e) -> {
            ...
            jCS.servico = new Servico(jCS.tfId.getText(), jCS.tfNome.getText().replaceAll(" ", ""), jCS.tfDescricao.getText());
    ...
    public static ActionListener cadastrarEquipamentos(JanelaCadastrarEquipamentos jCEq) {
        return (ActionEvent e) -> {
            ...
            jCEq.equipamento = new Equipamento(jCEq.tfId.getText(), jCEq.tfNome.getText().replaceAll(" ", ""),
